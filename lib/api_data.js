...
const cocktailByName = (searchName) => {
    ...
    .then((parsedResponse) => {
        ...
        const ingredients = [foundDrink.strMeasure1 + foundDrink.strIngredient1,foundDrink.strMeasure2 + foundDrink.strIngredient2,foundDrink.strMeasure3 + foundDrink.strIngredient3,foundDrink.strMeasure4 + foundDrink.strIngredient4,foundDrink.strMeasure5 + foundDrink.strIngredient5,
...
// exports.cocktailByName = cocktailByName